...
/*
      ...
      <body>
        ...
        <div class="text-left h2">
          Repack Session Report for <xsl:value-of select="$productName"/>, version <xsl:value-of select="$productVersion"/>
        </div>
        ...
        <xsl:for-each select="report/tables/table">
          ...
          <table align="center" style="border-collapse:collapse; table-layout:fixed">
            <xsl:choose>
			  ...
			  <xsl:when test="@name!='Excluded File Attributes' and (contains(@name, 'Excluded') or contains(@name, 'Included'))">
			...
			<xsl:choose>
                ...
                <tbody style="overflow-wrap:break-word; word-wrap:break-word; page-break-inside: avoid !important">
                  <xsl:for-each select="rows/row">
                    <tr>
                      <td>
						<center>
						  <img style="max-height: 100%;max-width: 100%;" src="data:image/png;base64,{cell[1]}"/>
                        </center>
			  ...
			  <xsl:when test="@name='Repackaging Scenario' or @name='Package Information' or @name='Customize Settings'">
                  <tbody style="overflow-wrap:break-word; word-wrap:break-word; page-break-inside: avoid !important">
                    <xsl:for-each select="rows/row">
                      <tr>
